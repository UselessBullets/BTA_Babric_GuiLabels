...
public class ChestMixin extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer() {
        this.fontRenderer.drawString(this.lowerChestInventory.getInvName(), 8, 6, GUIMod.GuiTextColor);
        this.fontRenderer.drawString(this.upperChestInventory.getInvName(), 8, this.ySize - 96 + 2, GUIMod.GuiTextColor);
    }
}
